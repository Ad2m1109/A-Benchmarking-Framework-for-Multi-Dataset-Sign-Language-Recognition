...
# Import the DatasetRegistry and ensure IndianSignLanguageDataset is registered
from datasets import DatasetRegistry
from indian_sign_language_dataset import IndianSignLanguageDataset  # This import registers the dataset
